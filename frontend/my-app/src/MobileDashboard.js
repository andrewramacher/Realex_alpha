...
import Browse from './mobileDashboardComponents/Browse';
import Chat from './mobileDashboardComponents/Chat';
import About from './About';
import Properties from './mobileDashboardComponents/Properties';
import p_logo from './images/Elegant.png';
import ClipLoader from "react-spinners/ClipLoader";
import Burger from './mobileDashboardComponents/burgerMenu/Burger/Burger';
import Menu from './mobileDashboardComponents/burgerMenu/Menu/Menu';
import {
    Redirect
...
class MobileDashboard extends React.Component {
    constructor(props) {
        ...
        this.onBurgerMenuClicked = this.onBurgerMenuClicked.bind(this);
    }
    ...
    browse() {
        this.setState({
            clicked: "BROWSE", burgerMenuOpen: false
        });
    }

    chatClicked() {
        this.setState({
            clicked: "CHAT", burgerMenuOpen: false
        });
    }

    properties() {
        this.setState({
            clicked: "PROPERTIES", burgerMenuOpen: false
        });
    }

    aboutClicked() {
        this.setState({
            clicked: "ABOUT", burgerMenuOpen: false
        });
    }
    ...
    onBurgerMenuClicked() {
        var newVal = !this.state.burgerMenuOpen;
        this.setState({burgerMenuOpen: newVal});
    }
        ...
        return (
          <div className="MobileDashboard">
            <div className="topBarMobile">
                <Burger open={this.state.burgerMenuOpen} setOpen={this.onBurgerMenuClicked}/>
                <img className="dashboardPlantMobile" height={72} width={108} src={p_logo} alt="P_logo"/>
                <button className="accountButtonMobile" onClick={this.onShowAccountScreen}>{this.state.username}</button>
            </div>
            {shown}
            {accountScreen}
            <Menu open={this.state.burgerMenuOpen} browseClicked={this.browse} chatClicked={this.chatClicked} propertiesClicked={this.properties} aboutClicked={this.aboutClicked}/>
          </div>
        );
    }
}
